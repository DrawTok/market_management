...
public class EmployeeService {
    ...
    public void updateEmployee(Employee employee) throws IOException {
        Employee currentEmployee = new Employee(employee.getUsername(), employee.getEmail(), employee.getPhoneNumber(), employee.getAddress(), employee.getFullName(),  employee.getBirthday(),employee.getDepartment(), employee.isStatus());
